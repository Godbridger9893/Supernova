...
### Core Highlights:
1. **Interactive Cybernetic Interface**: Features a 3D WebGL particle sphere with gyroscopic rings and audio-frequency waveforms that pulse, breathe, and rotate to speech.
...
- **📊 Instant Office & Document Builder**: Automatically creates PowerPoint (`.pptx`) decks, Excel (`.xlsx`) spreadsheets, Word (`.docx`) documents, and Markdown reports.
...
3. **Or launch manually with Python:**
   ```bash
   python3 -m venv .venv
...
2. Select your preferred **AI Brain Provider**:
